...
class UseUnpavedRoadsTest : public ::testing::Test {
protected:
  ...
  static void SetUpTestSuite() {
   ...
   E----F----G----H----I----A----J----K----L
    ...
    map = gurka::buildtiles(layout, ways, {}, {}, "test/data/use_unpaved_roads");
  }
};
...
TEST_F(UseUnpavedRoadsTest, UnpavedRoadsUnsupported) {
